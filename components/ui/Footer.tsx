...
export default function Footer(): ReactElement {
  return (
    <Card
      id="footer"
      className="bg-mantle hover:border-accent focus-visible:border-accent group h-full flex flex-col overflow-hidden rounded-xl border shadow-lg transition-all duration-300 hover:shadow-xl focus:outline-none"
    >
      <CardContent>
        <CardDescription>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 md:justify-start">
              ...
              <div>
                <StatusIndicator
                  ...
                  labelClassName="text-muted-foreground hover:text-accent transition-colors"
                />
              </div>
            </div>
